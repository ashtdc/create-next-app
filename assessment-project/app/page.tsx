...
const branches: Record<string, BranchInfo> = {
  ...
  Campbell: {
    ...
    phone: '(844) 824-6480',
    services: ['Assisted Living', 'Home Care'],
    zipCodes: ['95008', '95009', '95011', '95032', '95117', '95125', '95128', '95130'],
  },
  SanMateo: {
    name: 'San Mateo',
  ...
  SanFrancisco: {
    ...
    phone: '(650) 328-1001',
    services: ['Assisted Living', 'Home Care'],
    zipCodes: ['94101', '94102', '94103', '94104', '94105', '94106', '94107', '94108', '94109', '94110', '94111', '94112', '94114', '94115', '94116', '94117', '94118', '9119', '94120', '94121', '94122', '94123', '94124', '94126', '94127', '94129', '94130', '94131', '94132', '94133', '94134', '94135', '94136', '94137', '94138', '94139', '94141', '94142', '94143', '94144', '94145', '94146', '94147', '94150', '94152', '94153', '94154', '94155', '94156', '94157', '94158', '94159', '94160', '94161', '94162', '94163', '94164', '94165', '94166', '94167', '94168', '94169', '94170', '94171', '94172', '94175', '94177', '94188', '94199'],
  },
  PaloAlto: {
    name: 'Palo Alto',
    ...
    phone: '(844) 824-6480',
    services: ['Assisted Living', 'Home Care'],
    zipCodes: ['94020', '94022', '94024', '94028', '94301', '94302', '94303', '94304', '94306', '95033'],
  },
  WalnutCreek: {
    name: 'Walnut Creek',
  ...
  SanJose: {
    ...
    phone: '(844) 824-6480',
    services: ['Assisted Living', 'Home Care'],
    zipCodes: ['95101', '95102', '95103', '95106', '95108', '95109', '95111', '95112', '95113', '95114', '95115', '95116', '95117', '95118', '95119', '95120', '95121', '95122', '95123', '95124', '95125', '95126', '95127', '95128', '95129', '95130', '95131', '95132', '95133', '95134', '95135', '95136', '95137', '95138', '95139', '95140', '95141', '95142', '95148', '95150', '95151', '95152', '95153', '95154', '95155', '95156', '95157', '95158', '95159', '95160', '95161', '95162', '95163', '95164', '95165', '95166', '95167', '95168', '95169', '95170', '95171', '95172', '95173'],
  },
};
...
const Home: React.FC = () => {
  const [submittedData, setSubmittedData] = useState<FormData & { nearestBranch: NearestBranch } | null>(null);
    ...
    <div className="min-h-screen flex flex-col items-center justify-center py-2 bg-gray-50">
      {!submittedData ? (
        <div className="max-w-md text-black w-full space-y-8 p-10 bg-white rounded-xl shadow-lg">
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">CareIndeed Inquiry Form</h2>
          <InquiryForm onSubmit={handleFormSubmit} />
        </div>
      ) : (
        <div className="max-w-md text-black w-full space-y-8 p-10 bg-white rounded-xl shadow-lg">
          <h2 className="text-2xl font-bold text-gray-900">Hey, {submittedData.name}!</h2>
          <p>
            We have {submittedData.staffingType.join(', ')} available in our {submittedData.nearestBranch.branchName} Branch located at {submittedData.nearestBranch.branchInfo.address}.
          </p>
          <p>
            <strong>Phone:</strong> {submittedData.nearestBranch.branchInfo.phone}
          </p>
        </div>
      )}
    </div>
